...
class ReceiveSupplierDeliveryItemsRequestModel {
  Params params;

  ReceiveSupplierDeliveryItemsRequestModel({this.params});

  ReceiveSupplierDeliveryItemsRequestModel.fromJson(Map<String, dynamic> json) {
    params =
...
class Pickings {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.deliveryItems != null) {
      data['delivery_supplier_items'] = this.deliveryItems.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
